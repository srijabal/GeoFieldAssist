...
//       updateCurrentCapture({ measurements: newMeasurements });
//     }
...
//                 <FormControl>
//                   <Input type="number" placeholder="0-360" {...field} />
//                 </FormControl>
//                 <FormDescription>
...
//                 <FormControl>
//                   <Input type="number" placeholder="0-90" {...field} />
//                 </FormControl>
...
//           {currentCapture?.measurements?.length > 0 && (
